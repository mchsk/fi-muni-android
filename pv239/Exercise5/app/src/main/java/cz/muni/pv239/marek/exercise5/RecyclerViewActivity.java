...
import cz.muni.pv239.marek.exercise5.recyclerview.DividerItemDecoration;
import cz.muni.pv239.marek.exercise5.recyclerview.RecyclerTouchListener;
import cz.muni.pv239.marek.exercise5.recyclerview.WatchersAdapter;
...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Exercise5App) getApplication()).getAppComponent().inject(this);
